        ...
        <TouchableOpacity //  Situation (Global)
          ...
          <View style={{ marginBottom: 10 }}>
            <View
              ...
              <Text style={material.subheading}>
                {' '}
                <Icon name="radio-button-on" color="green" /> Số ca hồi phục
              </Text>
              <Text
                style={{
                  position: 'absolute',
          ...
          <View style={{ marginBottom: 10 }}>
            <View
              ...
              <Text style={material.subheading}>
                {' '}
                <Icon name="radio-button-on" color="red" /> Số ca tử vong
              </Text>
              <Text
                style={{
                  position: 'absolute',
          ...
          <View>
            <View
              ...
              <Text style={material.subheading}>
                {' '}
                <Icon name="radio-button-on" color="yellow" /> Tổng ca nhiễm
              </Text>
              <Text
                style={{
                  position: 'absolute',
